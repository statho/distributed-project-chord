...
echo "Eventual 3"
/usr/lib/erlang/bin/erl -noshell -s testcase1 main3 eventual 3 -s erlang halt
...
/usr/lib/erlang/bin/erl -noshell -s testcase1 main3 linearizability 3 -s erlang halt
